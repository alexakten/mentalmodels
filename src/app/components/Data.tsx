export const mentalModels = [
  {
    ...
    tags: ["Psychology", "Mathematics"],
  },
  {
    emoji: "📊",
    name: "The Pareto Principle",
    summary: "80% of results come from 20% of inputs.",
    definition:
  ...
  },
  {
    emoji: "🪒",
    name: "Occam's Razor",
    summary: "Simplicity usually wins.",
    definition:
  ...
  },
  {
    ...
    summary: "Work expands to fill available time.",
    definition:
  ...
  },
  {
    ...
    summary: "The cost of the next best choice.",
    definition:
  ...
  },
  {
    ...
    summary: "Exponential growth through reinvestment.",
    definition:
  ...
  },
  {
    ...
    summary: "Operate where you’re knowledgeable.",
    definition:
  ...
  },
  {
    ...
    summary: "Tackle bottlenecks first.",
    definition:
  ...
  {
    emoji: "🛠",
    name: "Tool vs. Goal Fallacy",
    summary: "Don’t let tools distract you from actual goals.",
    definition: "Tools should serve your objectives, not overshadow them.",
    example:
  ...
  },
  {
    ...
    summary: "We seek out what we already believe.",
    definition:
  ...
  },
  {
    ...
    summary: "The less you know, the more confident you are.",
    definition:
  ...
  },
  {
    ...
    summary: "Actions can have unexpected outcomes.",
    definition:
  ...
  },
  {
    emoji: "⚓️",
    name: "Anchor Effect",
    summary: "Initial information lingers in decisions.",
    definition:
  ...
  },
  {
    ...
    summary: "Don’t stick with something just because you’ve invested in it.",
    definition:
  ...
  },
  {
    ...
    summary: "Individual interest vs. group benefit.",
    definition:
  ...
  },
  {
    emoji: "🐍",
    name: "Cobra Effect",
    summary: "Incentives can backfire.",
    definition:
  ...
  },
  {
    ...
    summary: "Small changes can have large impacts.",
    definition:
  ...
  },
  {
    ...
    summary: "Beyond a point, more input yields fewer gains.",
    definition:
  ...
  },
  {
    emoji: "🕰",
    name: "Lindy Effect",
    summary: "The longer it’s been around, the longer it’s likely to last.",
    definition:
  ...
  },
  {
    ...
    summary: "Gradual changes go unnoticed.",
    definition:
  ...
  },
  {
    ...
    summary: "People rise to their level of incompetence.",
    definition:
  ...
  },
  {
    ...
    summary: "Shared resources get overused.",
    definition:
    ...
    tags: ["Economics", "Environmental Science"],
  },
  {
    emoji: "🔬",
    name: "Second-Order Thinking",
    summary: "Consider the consequences of consequences.",
    definition:
  ...
  },
  {
    emoji: "❓",
    name: "The 5 Whys",
    summary: "Keep asking why to find root causes.",
    definition:
  ...
  },
  {
    ...
    summary: "We remember incomplete tasks better.",
    definition:
  ...
  },
  {
    ...
    summary: "We overestimate how much others notice us.",
    definition:
  ...
  },
  {
    ...
    summary: "We focus on successes and ignore failures.",
    definition:
  ...
  },
  {
    ...
    summary: "We underestimate time for tasks.",
    definition:
  ...
  {
    emoji: "🏎",
    name: "Velocity vs. Speed Problem",
    summary: "Direction matters more than raw speed.",
    definition:
  ...
  },
  {
    ...
    summary: "You must keep improving just to stay in place.",
    definition:
    ...
    tags: ["Biology", "Business"],
  },
  {
    emoji: "🏃",
    name: "Hedonic Treadmill",
    summary: "We adapt to pleasure over time.",
    definition:
  ...
  },
  {
    ...
    summary: "Averages become stable with more data.",
    definition:
  ...
  },
  {
    emoji: "⚫️",
    name: "Black Swan",
    summary: "Rare events with huge impact.",
    definition: "Unpredictable outliers that drastically change outcomes.",
    example:
      "A global pandemic suddenly affecting all travel and industries worldwide.",
    tags: ["Economics", "Risk Management"],
  },
  {
    emoji: "🔎",
    name: "Law of Small Numbers",
    summary: "Small samples can mislead.",
    definition:
  ...
  },
  {
    ...
    summary: "High expectations enhance performance.",
    definition:
  ...
  },
  {
    ...
    summary: "Signs of disorder invite more disorder.",
    definition:
  ...
  },
  {
    ...
    summary: "Beliefs can influence outcomes.",
    definition:
  ...
  {
    emoji: "🤏",
    name: "Scarcity Mental Model",
    summary: "Limited availability increases perceived value.",
    definition: "People place higher value on things that appear to be scarce.",
    example:
  ...
  },
  {
    ...
    summary: "We overvalue what we own.",
    definition:
  ...
  },
  {
    ...
    summary: "Group members agree to a plan none of them want.",
    definition:
  ...
  },
  {
    ...
    summary: "We overemphasize one aspect of an event or situation.",
    definition:
  ...
  },
  {
    emoji: "🛟",
    name: "Normalcy Bias",
    summary: "We underestimate the possibility of disaster.",
    definition:
  ...
  },
  {
    ...
    definition: "A tendency to resist change even when it may offer benefits.",
    example:
  ...
  },
  {
    emoji: "🙈",
    name: "Ostrich Effect",
    summary: "We ignore negative information.",
    definition:
  ...
  },
  {
    ...
    summary: "We feel obligated to return favors.",
    definition:
  ...
  },
  {
    emoji: "👑",
    name: "Authority Bias",
    summary: "We trust and obey authority figures too readily.",
    definition:
  ...
  },
  {
    emoji: "💫",
    name: "Halo Effect",
    summary: "We see everything about a person as positive based on one trait.",
    definition:
  ...
  },
  {
    emoji: "🔪",
    name: "Horns Effect",
    summary: "One negative trait taints our entire perception.",
    definition:
  ...
  },
  {
    ...
    summary: "Comparisons distort perception.",
    definition:
  ...
  },
  {
    ...
    summary: "We judge probability by what’s most easily recalled.",
    definition:
  ...
  },
  {
    ...
    summary: "We judge likelihood by similarity to existing stereotypes.",
    definition:
  ...
  {
    emoji: "👌",
    name: "Satisficing Principle",
    summary: "Settle for ‘good enough’ instead of perfect.",
    definition:
  ...
  },
  {
    ...
    summary: "No one can be better off without making someone else worse off.",
    definition:
  ...
  },
  {
    emoji: "📌",
    name: "Tipping Point",
    summary: "Small changes accumulate to a big shift.",
    definition:
    ...
    tags: ["Sociology", "Marketing"],
  },
  {
    emoji: "📈",
    name: "Law of Averages",
    summary: "Outcomes of a random event will 'even out' in the short term.",
    definition:
    ...
    tags: ["Mathematics", "Psychology"],
  },
  {
    emoji: "📐",
    name: "Pareto Distribution",
    summary: "A few large events and many small ones.",
    definition:
  ...
  {
    emoji: "🔥",
    name: "Thermodynamics (as a Model)",
    summary: "Energy conservation and entropy can guide processes.",
    definition:
    ...
    tags: ["Physics", "Metaphor"],
  },
  {
    emoji: "🎰",
    name: "Gambler’s Fallacy",
    summary: "Belief that past random events influence future ones.",
    definition:
  ...
  },
  {
    ...
    summary: "Assuming the world is fair and people get what they deserve.",
    definition:
  ...
  },
  {
    ...
    summary: "We quickly adapt to good or bad changes.",
    definition:
  ...
  },
  {
    ...
    summary: "Discomfort from holding conflicting beliefs.",
    definition:
  ...
  {
    emoji: "🔍",
    name: "Reciprocity Fallacy",
    summary: "Expecting reciprocation even in mismatched relationships.",
    definition:
  ...
  },
  {
    ...
    summary: "Mastery requires extensive practice.",
    definition:
  ...
  },
  {
    ...
    summary: "Short-term sacrifice for long-term gain.",
    definition:
      "Resisting immediate temptations to achieve better outcomes later.",
    example: "Skipping dessert today for better health in the long run.",
    tags: ["Psychology", "Self-Control"],
  },
  {
    emoji: "🎮",
    name: "Super Mario Effect",
    summary: "Focus on the goal, treat failures like stepping stones.",
    definition:
  ...
  },
  {
    emoji: "🪑",
    name: "IKEA Effect",
    summary: "We overvalue things we assemble ourselves.",
    definition:
  ...
  },
  {
    emoji: "📈",
    name: "Flynn Effect",
    summary: "IQ scores tend to increase from one generation to the next.",
    definition:
  ...
  {
    emoji: "📚",
    name: "Knowledge Doubling Curve",
    summary: "Human knowledge grows exponentially.",
    definition:
  ...
  },
  {
    emoji: "🔔",
    name: "Bell Curve",
    summary: "Normal distribution of traits or data.",
    definition:
  ...
  },
  {
    emoji: "1️⃣",
    name: "1% Rule",
    summary: "Small daily improvements lead to big results.",
    definition: "Improving by 1% each day compounds significantly over time.",
    example:
  ...
  },
  {
    emoji: "🍕",
    name: "Two Pizza Rule",
    summary: "Keep teams small enough for two pizzas to feed them.",
    definition:
  ...
  {
    emoji: "🪶",
    name: "Law of Least Effort",
    summary: "People naturally choose the path of least resistance.",
    definition:
  ...
  },
  {
    ...
    summary: "We look for answers where it’s easiest to search.",
    definition:
  ...
  },
  {
    ...
    summary: "Difficulty starting when each part depends on the other.",
    definition:
  ...
  },
  {
    ...
    summary: "Future money is worth less than present money.",
    definition:
  ...
  },
  {
    ...
    summary: "Leave room for error in decisions.",
    definition:
  ...
  {
    emoji: "🌐",
    name: "Circle of Influence vs. Circle of Concern",
    summary: "Focus energy on what you can control.",
    definition:
  ...
  {
    emoji: "🚦",
    name: "Swim Lane Theory",
    summary: "Assign clear, separate responsibilities.",
    definition:
  ...
  },
  {
    ...
    definition: "Solutions are most effective when kept as simple as possible.",
    example: "A single-page checklist can often outperform a lengthy manual.",
    tags: ["Design", "Engineering"],
  },
  {
    emoji: "🧠",
    name: "RAS Theory (Reticular Activating System)",
    summary: "We notice what we focus on.",
    definition:
  ...
  },
  {
    emoji: "🕵️",
    name: "Curiosity Gap",
    summary: "We’re driven to fill knowledge gaps.",
    definition:
  ...
  },
  {
    ...
    summary: "We can maintain about 150 stable social relationships.",
    definition:
  ...
  },
  {
    ...
    summary: "Emotional response overrides rational thinking.",
    definition:
  ...
  },
  {
    ...
    summary: "The brain changes with experience.",
    definition:
  ...
  },
  {
    ...
    summary: "Group information for easier recall.",
    definition:
  ...
  },
  {
    ...
    summary: "A system’s weakest link sets its limit.",
    definition:
  ...
  {
    emoji: "🧊",
    name: "Iceberg Principle",
    summary: "Most of the problem is hidden below the surface.",
    definition:
  ...
  },
  {
    emoji: "🌐",
    name: "Babel Problem",
    summary: "Communication fails when everyone speaks differently.",
    definition:
  ...
  },
  {
    emoji: "🤔",
    name: "Groupthink",
    summary: "Harmony in a group leads to poor decisions.",
    definition:
  ...
  },
  {
    ...
    tags: ["Psychology", "Pattern Recognition"],
  },
  {
    emoji: "🪞",
    name: "Capgras Delusion",
    summary: "Belief that a familiar person is replaced by an imposter.",
    definition:
